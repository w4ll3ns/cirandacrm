    ...
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <div className="flex items-center gap-3 px-2 py-2">
          <img src="/logo.png" alt="Dezenas CRM" className="w-9 h-9 rounded-xl object-contain shrink-0" />
          {!collapsed && (
            <div className="min-w-0">
              <p className="font-bold text-sm truncate">Dezenas CRM</p>
              <p className="text-[10px] text-muted-foreground truncate">Realizando Sonhos!</p>
            </div>
          )}
        </div>
      </SidebarHeader>
